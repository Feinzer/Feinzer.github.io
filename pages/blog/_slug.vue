...
<template>
  <div class="post m-2 md:m-10 flex flex-col p-6 shadow bg-fz-light-gray rounded-lg text-white">
    <div class="flex flex-row items-center justify-between w-full px-4 pb-8">
      <span />
